// @flow
import React, { useRef, useEffect, forwardRef, FC } from 'react'
import {
  useTable,
  useSortBy,
  usePagination,
...
interface IGlobaleFilter {
  preGlobalFilteredRows: any
  globalFilter: any
  setGlobalFilter: any
  searchBoxClass: any
}
const GlobalFilter: FC<IGlobaleFilter> = ({
...
const IndeterminateCheckbox: FC<{ indeterminate: any }> = forwardRef(
