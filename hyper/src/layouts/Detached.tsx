// @flow
import React, { Suspense, useCallback, useEffect, useState, FC } from 'react'
...
const DetachedLayout: FC<VerticalLayoutProps> = ({ children }) => {
  const dispatch = useDispatch()
  const { leftSideBarTheme, leftSideBarType, showRightSidebar } = useSelector(
    (state: RootState) => ({
